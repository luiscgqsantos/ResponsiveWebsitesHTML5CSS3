...
<body>
    ...
    <header>
        ...
        <div class="hero-text-box">
            ...
            <a class="btn btn-ghost js--scrol-to-start" href="#">Show me more</a>
        </div>
    </header>
            ...
            <div class="row">
                <form method="post" action="mailer-new.php" class="contact-form">
                    <div class="row">
                        <?php
                        if($_GET['success'] == 1) {
                            echo "<div class=\"form-messages success\">Thank you! Your message was sent!</div>";
                        } 
                        if($_GET['success'] == -1) {
                    ...
                    <div class="row">
                        <div class="col span-1-of-3">
                            <label for="finde-us">How did you find us?</label>
                        </div>
                        <div class="col span-2-of-3">
                            <select name="finde-us" id="finde-us">
    ...
    <footer>
        ...
        <div class="row">
            <p>Copyright &copy; 2019 by Omnifood. All right reserverd.</p>
        </div>
    </footer>
